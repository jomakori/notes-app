...
export const Local: BaseURL = import.meta.env.VITE_API_ENDPOINT as string;
...
class BaseClient {
  ...
  public async callAPI(
    ...
    // Log the full URL of the request for debugging
    console.log(`Making request to: ${this.baseURL + path + (query ? "?" + encodeQuery(query) : "")}`);
